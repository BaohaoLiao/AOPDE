...
SAVE_DIR=${SAVE_DIR:-/root/Qwen3-4B_retool_search_interleaved_opd}

: "${RETOOL_PROMPT_DATA:?Set RETOOL_PROMPT_DATA to the Retool prompt file.}"
: "${SEARCH_R1_PROMPT_DATA:?Set SEARCH_R1_PROMPT_DATA to the Search-R1 prompt file.}"
...
RUNTIME_ENV_JSON="{
  \"env_vars\": {
    \"PYTHONPATH\": \"/root/Megatron-LM/:${SCRIPT_DIR}:${REPO_DIR}:${SLIME_DIR}\",
