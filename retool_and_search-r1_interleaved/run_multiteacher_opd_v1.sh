...
SAVE_DIR=${SAVE_DIR:-${BOTH_MODEL_DIR}/Qwen3-4B-Instruct-2507-SFT-RL-to-Qwen3-4B-Instruct-2507-SFT-interleaved-two-task-retool1seachr10}
...
START_SEARCH_R1_TEACHER=${START_SEARCH_R1_TEACHER:-0}
...
if [ "${START_SEARCH_R1_TEACHER}" = "1" ]; then
   SEARCH_R1_LAUNCH_INFO=$(
      launch_teacher \
         ...
         "${SEARCH_R1_TEACHER_MAX_TOTAL_TOKENS:-20000}" \
...
WANDB_GROUP=${WANDB_GROUP:-Both_Qwen3-4B-Instruct-2507-SFT-RL-to-Qwen3-4B-Instruct-2507-SFT-interleaved-two-task-retool1seachr10}
