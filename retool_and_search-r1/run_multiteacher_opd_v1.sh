...
SAVE_DIR=${SAVE_DIR:-${BOTH_MODEL_DIR}/Qwen3-4B-Instruct-2507-SFT-RL-to-Qwen3-4B-Instruct-2507-SFT-mixed-two-file-retool1searchr10}
...
MIXED_TASK_ORDER=${MIXED_TASK_ORDER:-retool}
...
WANDB_GROUP=${WANDB_GROUP:-Both_Qwen3-4B-Instruct-2507-SFT-RL-to-Qwen3-4B-Instruct-2507-SFT-mixed-two-file-retool1searchr10}
